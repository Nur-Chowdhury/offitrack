    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 w-full bg-white dark:bg-black">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
                <input
                    type="text"
                    className="w-full sm:w-[300px] p-2 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 
                    rounded-lg bg-gray-50 dark:bg-gray-700 focus:ring-blue-500 focus:border-blue-500"
                ...
                {isAdmin && (
                    <button
                        className="w-full sm:w-auto px-4 py-2 bg-blue-700 hover:bg-blue-600 text-sm rounded-lg cursor-pointer 
            ...
            {filteredMembers.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {filteredMembers.map(({ user, role }) => (
                        <div key={user.id} 
                            className="p-4 border rounded-lg shadow-sm flex flex-col justify-between dark:bg-gray-950 dark:border-gray-700"
                        >
                            <div>
                            ...
                            <div className="mt-4">
                                ...
                                <select
                                    ...
                                    className="w-full p-2 text-sm rounded-md bg-gray-100 dark:bg-gray-800 border-transparent focus:border-blue-500 focus:ring-blue-500 
